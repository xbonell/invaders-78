...
import type { GameCanvasHostProps } from '../../arcade/render/types';
...
/**
 * Shared R3F host: lights, context recovery, sim driver.
 * Playfield graphics come from a game `RenderBackend` as `children`.
 */
export function GameCanvas({
  advanceRef,
  onContextLost,
  children,
}: GameCanvasHostProps): ReactNode {
  return (
    <Canvas
      orthographic
